...
public class Aisle {
    ...
    public enum Status { FULL, EMPTY, NORMAL }
 ...
 */
     ...
     * @return This Aisle can be FULL, EMPTY or just NORMAL. ( NORMAL meaning that it just is operating properly )
     */
    ...
    /**
     * This will fill the Aisle with the specified item and sets the Status of this Aisle to LOADED
    ...
    /**
     * Will check the list of items in this aisle for being at it's limit or being empty and sets the Status accordingly.
     */
